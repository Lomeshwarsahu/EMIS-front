...
@Component({
  selector: 'app-item-wise-detail-poqty',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './item-wise-detail-poqty.component.html',
  styleUrls: [
    '../../component/Suppliers/supplier-po-pages.shared.css',
    './item-wise-detail-poqty.component.css'
  ],
})
export class ItemWiseDetailPOQtyComponent {
  ...
  goBack() {
    this.router.navigate(['/reports/item-wise-detail']);
  }
