...
@Component({
  selector: 'app-payments-cpreport-igm',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './payments-cpreport-igm.component.html',
  styleUrls: [
    '../../component/Suppliers/supplier-po-pages.shared.css',
    './payments-cpreport-igm.component.css'
  ],
})
export class PaymentsCpreportIgmComponent {
  fromDate: string = '';
  toDate: string = '';
  poType: string = 'All';
  dispatchData: any[] = [];
  ...
  displayedColumns: string[] = [
    'sno', 'supplierName', 'countNos', 'chequeAmount', 'adminCharges',
    'aidNo', 'chequeDate', 'paidOn', 'paymentId', 'budgetName',
    'totalCheque', 'mobile', 'email'
  ];
  ...
  loadData() {
    ...
    this.loading = true;
    const apiUrl = `Reports/payments-cpreport-igm?poType=${this.poType}&fromDate=${this.fromDate}&toDate=${this.toDate}`;
