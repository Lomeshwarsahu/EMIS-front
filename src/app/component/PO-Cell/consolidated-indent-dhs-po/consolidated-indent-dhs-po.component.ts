...
@Component({
  selector: 'app-consolidated-indent-dhs-po',
   standalone: true,
  imports: [
    NgSelectModule,
    CommonModule,
  ...
  templateUrl: './consolidated-indent-dhs-po.component.html',
  styleUrl: './consolidated-indent-dhs-po.component.css',
})
export class ConsolidatedIndentDHSPOComponent {
Yearlist: any = {};
Diectoratelist: any = {};
selecteditem:any;
yearid:any;
