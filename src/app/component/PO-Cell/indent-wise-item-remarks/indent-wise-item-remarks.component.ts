...
@Component({
  selector: 'app-indent-wise-item-remarks',
   standalone: true,
  imports: [
    NgSelectModule,
    CommonModule,
  ...
  templateUrl: './indent-wise-item-remarks.component.html',
  styleUrl: './indent-wise-item-remarks.component.css',
})
export class IndentWiseItemRemarksComponent {
