...
@Component({
  selector: 'app-rdlctender-summary',
  standalone: true,
  imports: [
    NgSelectModule,
    CommonModule,
  ...
  templateUrl: './rdlctender-summary.component.html',
  styleUrl: './rdlctender-summary.component.css',
})
export class RDLCTenderSummaryComponent {
  // RDLCRport
  termsConditionsData: any[] = [];
// Complete comprehensive configuration schema matching your fields payload
displayedColumns: string[] = [
  ...
  constructor(
    ...
    this.dataSource = new MatTableDataSource<RDLCRport>([]);
  }

  ngOnInit() {
    this.Getitemwisedetail();
  }
  // https://localhost:7036/api/POCell/GetTenderSummaryReport
  Getitemwisedetail() {
    try {
      this.spinner.show();
      const url = 'POCell/GetTenderSummaryReport';
