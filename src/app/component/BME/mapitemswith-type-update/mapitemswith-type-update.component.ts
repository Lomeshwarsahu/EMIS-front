...
@Component({
  selector: 'app-mapitemswith-type-update',
 standalone: true,
  imports: [
    NgSelectModule,
    CommonModule,
  ...
  templateUrl: './mapitemswith-type-update.component.html',
  styleUrl: './mapitemswith-type-update.component.css',
})
export class MapitemswithTypeUpdateComponent {
mappingForm!: FormGroup; 
  ...
  displayedColumns: string[] = ['select', 'sno', 'ItemCodeAsPerTender', 'ItemName', 'ItemId'];
